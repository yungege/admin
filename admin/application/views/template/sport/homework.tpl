            ...
            <table class="table table-bordered table-hover table-striped text-center">
                ...
                <tbody>
                    ...
                    <tr data-id="{%$row._id%}">
                        ...
                        <td>{%if $row.status == 1%}<span class="label label-success">锻炼中</span>{%elseif $row.status == -1%}<span class="label label-danger">已过期</span>{%else%}<span class="label label-default">未生效</span>{%/if%}</td>
                        <td>
